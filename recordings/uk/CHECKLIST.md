...
**0 / 1095 recorded.** Save files into `recordings/uk/phonemes/` and `recordings/uk/words/` — filename must match exactly. See recordings/README.md for tips.
...
## Spoken prompts  → `recordings/uk/ui/`
